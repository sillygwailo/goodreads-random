...
6. `export USER_AGENT="Goodreads Random / you@example.com / https://github.com/sillygwailo/goodreads-random"
7. `export CALLBACK_URL=http://localhost:5000/auth/goodreads/callback` # replace localhost:5000 with the hostname (and, optionally, port) of where you're hosting the app
8. `node app.js`
